...
6. 300행, 400열의 행렬을 회색 바탕색으로 생성해서 500행, 600열의 윈도우에 표시하시오
`prob6.py` 참조
...
12. 05.event_trackbar.py에서 화살표 키로 트랙바를 이동하는 코드를 추가하시오
`prob12.py` 참조

13. 컬러 영상파일을 적재하여 "test.jpg" 와 "test.png" 파일로 각각 저장하시오.
